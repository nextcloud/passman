OC.L10N.register(
    ...
    "Generate password on creation" : "توليد كلمة المرور عند الإنشاء",
    ...
    "Password score" : "قوة كلمة المرور",
    ...
    "An admin then accepts or declines the request" : "بعد ذلك يقبل المدير الطلب أو يرفضه",
    "After an admin destroys this vault, all credentials in it will be lost" : "بعد أن يقوم المدير بتدمير هذه الخزينة، سوف تفقد جميع بيانات الاعتماد الموجودة فيه",
    "Reason for requesting deletion (optional):" : "سبب طلب الحذف (اختياري):",
    "Request vault destruction" : "طلب تدمير خزينة",
    "Yes, request an admin to destroy this vault" : "نعم، اطلب من المدير تدمير هذه الخزينة",
