OC.L10N.register(
    ...
    "A Passman item has been created, modified or deleted" : "تم إنشاء، تعديل أو حذف عنصر تطبيق إدارة كلمات المرور باس مان \"Passman\"",
    "A Passman item has expired" : "انتهت صلاحية عنصر تطبيق إدارة كلمات المرور باس مان \"Passman\"",
    "A Passman item has been shared" : "تمت مشاركة عنصر تطبيق إدارة كلمات المرور باس مان \"Passman\"",
    "A Passman item has been renamed" : "تم إعادة تسمية عنصر تطبيق إدارة كلمات المرور باس مان \"Passman\"",
    ...
    "Adding {{credential}}" : "إضافة {{بيانات اعتماد}}",
    ...
    "Parsed {{num}} credentials, starting to import" : "تم تحليل بيانات الاعتماد {{عدد}}، وبدء الاستيراد",
    "Importing" : "استيراد",
    "Start import" : "بدأ الاستيراد",
    "Select CSV file" : "حدد ملف سي اس في \"تنسيق القيم المفصولة بفواصل CSV \"",
    "Parsed {{rows}} lines from CSV file" : "تم تحليل السطور {{rows}} من ملف سي اس في \"تنسيق القيم المفصولة بفواصل CSV \"",
    ...
    "About Passman" : "عن تطبيق إدارة كلمات المرور باس مان \"Passman\"",
    "Version" : "الإصدار",
    ...
    "Accept" : "قبول",
    "Decline" : "رفض",
    "You have {{session_time}} left before logout." : "متبقي لديك {{وقت_الجلسة}} قبل تسجيل الخروج.",
    "Your vault has been locked for {{time}} because of {{tries}} failed attempts!" : "تم قفل خزينتك لمدة {{وقت}} بسبب {{محاولات}} عدد من المحاولات الفاشلة!",
    "Hello there!" : "مرحبا",
    ...
    "Never" : "أبدا",
    "No vaults found, why not create one?" : "لم يتم العثور علي خزائن، لماذا لا تقو بإنشاء واحدة؟",
    ...
    "Request removed" : "تم نقل/ إزالة الطلب",
    "Destruction request pending" : "طلب تدمير معلق",
    "Warning! Adding credentials over HTTP is insecure!" : "تحذير! إضافة بيانات الاعتماد عبر بروتوكول نقل النص التشعبي \"HTTP \"غير آمن!",
    "Logged into {{vault_name}}" : "تم تسجيل الدخول إلى {{اسم_الخزينة}}",
    ...
    "Enable HTTPS check" : "تمكين التحقق من بروتوكول نقل النص الفائق الآمن \"HTTPS\"",
    ...
    "Allow users on this server to share passwords with a link" : "تمكين المستخدمين على هذا الخادوم من مُشاركة كلمات المرور مع رابط",
