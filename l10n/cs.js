OC.L10N.register(
    ...
    "Missing an importer? Click here to try it with the generic CSV importer." : "Chybí nástroj pro import? Klikněte sem a zkuste to s obecným pro CSV.",
    ...
    "Since all data has to be downloaded, re-encrypted and uploaded again when changing the password, this process is error-prone. It is strongly recommended to have an updated backup of your vault before changing the password." : "Protože je při změně hesla třeba znovu stáhnout, znovu zašifrovat a znovu nahrát veškerá data, je tento proces náchylný k chybám. Před změnou hesla je silně doporučováno mít aktuální zálohu vašeho trezoru.",
    ...
    "Log out of this vault automatically after:" : "Automaticky odhlásit z tohoto trezoru po nečinnosti:",
    "30 minutes" : "30 minut",
    "60 minutes" : "60 minut",
    "3 hours" : "3 hodin",
    "8 hours" : "8 hodin",
    ...
    "Loading" : "Načítání",
    "Oops! Credential not found. Maybe it expired." : "Jejda! Přihlašovací údaje nenalezeny. Možná jejich platnost skončila.",
