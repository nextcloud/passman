OC.L10N.register(
    ...
    "Get icon from page" : "Få ikon fra side",
    "This may take a few seconds …" : "Det kan tage et par sekunder..",
    "There was an error fetching the icon!" : "Der var en fejl med ikonet!",
    ...
    "Missing users? Only users that have vaults are shown." : "Mangler du brugere? Kun brugere, der har boks, vises.",
    "Cyphering" : "Cyphering",
    "Uploading" : "Uploader",
    "User" : "Bruger",
    ...
    "Offline attack, fast hash, many cores" : "Offline angreb, hash, mange kerner",
    ...
    "Accept" : "Accepter",
    "Decline" : "Afvis",
    "You have {{session_time}} left before logout." : "Du har {{session_time}} tilbage før logout.",
    ...
    "Cancel destruction request" : "Annuller destruktions anmodning",
    ...
    "Mark as Compromised" : "Marker som Kompromitteret",
    ...
    "Enable HTTPS check" : "Aktiver HTTPS kontrol",
    "Disable context menu" : "Deaktiver kontekstmenu",
    "Disable JavaScript debugger" : "Deaktiver JavaScript debugger",
    "Enable global search" : "Aktiver global søgning",
