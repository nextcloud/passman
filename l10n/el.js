OC.L10N.register(
    ...
    "Passman is a full-featured password manager." : "Το Passman είναι ένας διαχειριστής συνθηματικών με πλήρεις δυνατότητες.",
    ...
    "Minimum vault key strength" : "Ελάχιστη δύναμη κλειδιού θησαυροφυλακίου",
