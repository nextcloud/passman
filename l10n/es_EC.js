OC.L10N.register(
    ...
    "Generating sharing keys (%s/2)" : "Generando claves de uso compartido (%s/2)",
    ...
    "Error downloading file, you probably have insufficient permissions" : "Error al descargar el archivo, es probable que no tenga permisos suficientes",
    ...
    "Failed to decrypt {{credential}}" : "Error al descifrar {{credencial}}",
    "Done" : "Terminado",
    ...
    "Skipping unlabeled credential" : "Saltando credencial sin etiquetas",
    ...
    "Missing an importer? Click here to try it with the generic CSV importer." : "¿Falta un importador? Haga clic aquí para intentarlo con el importador genérico de CSV.",
    ...
    "Since all data has to be downloaded, re-encrypted and uploaded again when changing the password, this process is error-prone. It is strongly recommended to have an updated backup of your vault before changing the password." : "Dado que todos los datos deben descargarse, volver a cifrarse y volver a cargar al cambiar la contraseña, este proceso es propenso a errores. Se recomienda encarecidamente tener una copia de seguridad actualizada de su bóveda antes de cambiar la contraseña.",
    ...
    "Old password field incorrect!" : "¡El campo de contraseña antigua es incorrecto!",
    ...
    "Upload a custom icon:" : "Cargar un icono personalizado:",
    "Use this icon" : "Usar este ícono",
    "Delete current icon" : "Eliminar icono actual",
    "Get icon from page" : "Obtener icono desde página",
    "This may take a few seconds …" : "Esto puede tardar unos segundos ...",
    "There was an error fetching the icon!" : "¡Hubo un error al obtener el icono!",
    ...
    "Save your passwords with one click." : "Guarde sus contraseñas con un solo clic.",
    ...
    "The password tool scans your password, calculates average cracking time, listing those below the threshold" : "La herramienta de contraseña escanea su contraseña, calcula el tiempo promedio de descifrado y enumera aquellos que están por debajo del umbral",
    ...
    "Total time spent encrypting" : "Tiempo total empleado en el cifrado",
    "Read" : "Leer",
    "Write" : "Escribir",
    "Files" : "Archivo",
    ...
    "Click \"Share\" first" : "Haga clic en \"Compartir\" primero",
    ...
    "log out of this vault and log into the vault you want the shared credential in." : "cerrar sesión de esta bóveda y acceder a la bóveda en la que desea la credencial compartida.",
    ...
    "Hello there!" : "¡Hola! ¡Bienvenido!",
    "It does not seem that you have any passwords. Do you want to add one?" : "No parece que tengas contraseñas. ¿Quieres agregar una?",
    "You don't have good credentials" : "No tienes credenciales buenas",
    "You don't have medium credentials" : "No tienes credenciales medianas",
    "You don't have bad credentials" : "No tienes credenciales malas",
    "You don't have expired credentials" : "No tienes credenciales vencidas",
    "You don't have deleted credentials" : "No tienes credenciales eliminadas",
    "There are no credentials with your selected tags" : "No hay credenciales con las etiquetas seleccionadas",
    "There are no credentials matching" : "No hay credenciales coincidentes",
    ...
    "Your sharing keys will have a strength of 1024 bit, which you can change in \"Settings\" later." : "Tus claves de uso compartido tendrán una longitud de 1024 bits, lo que puedes cambiar en \"Configuración\" más tarde.",
    ...
    "Log out of this vault automatically after:" : "Cerrar sesión automáticamente de esta bóveda después de:",
    ...
    "Logged into {{vault_name}}" : "Sesión iniciada en {{nombre_de_la_bóveda}}",
    ...
    "Bad Strength" : "Fortaleza Baja",
    "Expired" : "Expirado",
    "Compromised" : "Comprometido",
    "Filter Tags" : "Etiquetas de filtro",
    "Simple Navigation" : "Navegación simple",
    ...
    "Loading …" : "Loading …",
    "Oops! Credential not found. Maybe it expired." : "¡Ups! Credencial no encontrada. Tal vez haya expirado.",
    "Mark as Compromised" : "Marcar como Comprometido",
    "Compromised!" : "¡Comprometido!",
    "This password is compromised. You can only remove this warning by changing the password." : "Esta contraseña está comprometida. Solo puede eliminar esta advertencia cambiando la contraseña.",
    "email" : "correo electrónico",
    "Description" : "Descripción",
    "Custom Search:" : "Búsqueda personalizada:",
    "Revert to defaults" : "Revertir a los valores predeterminados",
    ...
    "Passman is a full featured password manager." : "Passman es un gestor de contraseñas completo.",
    "Passman is a full featured password manager.\nFeatures:\n- Vaults\n- Vault key is never sent to the server\n- Browser extension for easy access to passwords\n- Android app for on the road access\n- Credentials are client side encrypted with 256bit AES\n- Credentials are server side encrypted with 256bit AES\n- Ability to add custom fields to credentials\n- Built-in OTP (One Time Password) generator\n- Password analyzer\n- Share passwords internally and via link in a secure manner.\n- Import from various password managers (KeePass, LastPass, DashLane, ZOHO, Clipperz.is )\nFor an demo of this app visit [https://demo.passman.cc](https://demo.passman.cc)" : "Passman es un gestor de contraseñas completo.\n      Características:\n      - Bóvedas\n      - La clave de la bóveda nunca se envía al servidor\n      - Extensión del navegador para un fácil acceso a las contraseñas\n      - Aplicación para Android para acceder en movimiento\n      - Las credenciales se cifran en el lado del cliente con AES de 256 bits\n      - Las credenciales se cifran en el servidor con AES de 256 bits\n      - Capacidad para agregar campos personalizados a las credenciales\n      - Generador OTP (One Time Password) integrado\n      - Analizador de contraseñas\n      - Compartir contraseñas internamente y mediante enlaces de forma segura.\n      - Importar desde varios gestores de contraseñas (KeePass, LastPass, DashLane, ZOHO, Clipperz.is)\n      Para una demostración de esta aplicación, visite [https://demo.passman.cc](https://demo.passman.cc)",
    ...
    "Enable global search" : "Habilitar búsqueda global",
