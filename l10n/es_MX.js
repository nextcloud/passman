OC.L10N.register(
    ...
    "If you want this vault removed you can request removal of the vault here." : "Si desdea eliminar esta bóveda, puede solicitarlo aqui. ",
    ...
    "Your credential \"%s\" expired, click here to update the credential." : "Sus credenciales \"%s\" han caducado, haga click aqui para actualizarlas. ",
    "Remind me later" : "Recordarme más tarde",
    "Ignore" : "Ignorar",
    "%s shared \"%s\" with you. Click here to accept" : "%s compartió \"%s\" con usted. Haga click aqui para aceptar",
