OC.L10N.register(
    ...
    "Missing an importer? Click here to try it with the generic CSV importer." : "واردکننده‌ای پیدا نکردید؟ اینجا کلیک کنید تا با واردکنندهٔ عمومی CSV امتحان کنید.",
    ...
    "Since all data has to be downloaded, re-encrypted and uploaded again when changing the password, this process is error-prone. It is strongly recommended to have an updated backup of your vault before changing the password." : "از آنجا که هنگام تغییر گذرواژه باید همهٔ داده‌ها بارگیری، دوباره رمزگذاری و بارگذاری شوند، این فرایند مستعد خطاست. اکیداً توصیه می‌شود پیش از تغییر گذرواژه، یک پشتیبان به‌روز از طاق خود داشته باشید.",
    ...
    "Generate password on creation" : "تولید گذرواژه هنگام ایجاد",
    ...
    "Your sharing keys will have a strength of 1024 bit, which you can change in \"Settings\" later." : "کلیدهای اشتراک‌گذاری شما قدرتی برابر با ۱۰۲۴ بیت خواهند داشت که بعداً می‌توانید آن را در \"تنظیمات\" تغییر دهید.",
    ...
    "Log out of this vault automatically after:" : "خروج خودکار از این طاق پس از:",
    ...
    "Loading …" : "بارگذاری …",
    "Oops! Credential not found. Maybe it expired." : "اوه! اعتبارنامه پیدا نشد. شاید منقضی شده باشد.",
    ...
    "Enable global search" : "فعال کردن جستجوی سراسری",
