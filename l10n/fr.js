OC.L10N.register(
    ...
    "Showing revisions of \"{{label}}\"" : "Affichage des révisions de \"{{label}}\"",
    ...
    "Passman is a full-featured password manager." : "Passman est un gestionnaire de mots de passe complet.",
    "**Passman** is a full-featured, open source password manager for Nextcloud.\n\n## Features:\n- Vaults\n- Vault key is never sent to the server\n- Browser extension for easy access to passwords\n- Android app for on the road access\n- Credentials are client side encrypted with 256bit AES\n- Credentials are server side encrypted with 256bit AES\n- Ability to add custom fields to credentials\n- Built-in OTP (One Time Password) generator\n- Password analyzer\n- Share passwords internally and via link in a secure manner.\n- Import from various password managers (KeePass, LastPass, DashLane, ZOHO, Clipperz.is)\n\n## Demo\nFor a demo of this app visit [https://demo.passman.cc](https://demo.passman.cc)" : "**Passman** est un gestionnaire de mots de passe complet et open source pour Nextcloud.\n\n## Fonctionnalités :\n- Coffres-forts\n- La clé du coffre-fort n'est jamais envoyée au serveur\n- Extension de navigateur pour faciliter l'accès aux mots de passe\n- Application Android pour l'accès mobile\n- Chiffrement des informations d'identification côté client avec AES 256 bits\n- Chiffrement des informations d'identification côté serveur avec AES 256 bits\n- Possibilité d'ajouter des champs personnalisés aux informations d'identification\n- Générateur OTP (mot de passe à usage unique) intégré\n- Analyseur de mots de passe\n- Partage des mots de passe en interne et via des liens de façon sécurisée.\n- Importation depuis différents gestionnaires de mots de passe (KeePass, LastPass, DashLane, ZOHO, Clipperz.is)\n\n## Démonstration\nPour une démonstration de cette application, visitez [https://demo.passman.cc](https://demo.passman.cc)",
    ...
    "Minimum vault key strength" : "Force minimale de la clé du coffre-fort",
