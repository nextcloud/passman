OC.L10N.register(
    ...
    "Showing revisions of \"{{label}}\"" : "Ag taispeáint athbhreithnithe ar \"{{label}}\"",
    ...
    "Passman is a full-featured password manager." : "Is bainisteoir pasfhocal lánfheistithe é Passman.",
    "**Passman** is a full-featured, open source password manager for Nextcloud.\n\n## Features:\n- Vaults\n- Vault key is never sent to the server\n- Browser extension for easy access to passwords\n- Android app for on the road access\n- Credentials are client side encrypted with 256bit AES\n- Credentials are server side encrypted with 256bit AES\n- Ability to add custom fields to credentials\n- Built-in OTP (One Time Password) generator\n- Password analyzer\n- Share passwords internally and via link in a secure manner.\n- Import from various password managers (KeePass, LastPass, DashLane, ZOHO, Clipperz.is)\n\n## Demo\nFor a demo of this app visit [https://demo.passman.cc](https://demo.passman.cc)" : "Is bainisteoir pasfhocal foinse oscailte lánghnéitheach é **Passman** do Nextcloud.\n\n## Gnéithe:\n- Cruinneacháin\n- Ní sheoltar eochair an chruinneacháin chuig an bhfreastalaí riamh\n- Síneadh brabhsálaí le haghaidh rochtain éasca ar phasfhocail\n- Aip Android le haghaidh rochtana ar an mbóthar\n- Tá dintiúir criptithe taobh an chliaint le AES 256 giotán\n- Tá dintiúir criptithe taobh an fhreastalaí le AES 256 giotán\n- Cumas réimsí saincheaptha a chur le dintiúir\n- Gineadóir OTP (Pasfhocal Aonuaire) ionsuite\n- Anailíseoir pasfhocal\n- Pasfhocail a roinnt go hinmheánach agus trí nasc ar bhealach slán.\n- Iompórtáil ó bhainisteoirí pasfhocal éagsúla (KeePass, LastPass, DashLane, ZOHO, Clipperz.is)\n\n## Taispeántas\nChun taispeántas den aip seo a fheiceáil, tabhair cuairt ar [https://demo.passman.cc](https://demo.passman.cc)",
    "Passman Settings" : "Socruithe Passman",
    "GitHub version:" : "Leagan GitHub:",
    "Local version:" : "Leagan áitiúil:",
    ...
    "Minimum vault key strength" : "Neart íosta eochrach cruinneacháin",
