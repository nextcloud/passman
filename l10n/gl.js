OC.L10N.register(
    ...
    "You created %1$s" : "Vde. creou %1$s",
    "%1$s has been updated by %2$s" : "%1$s foi actualizado por %2$s",
    "You updated %1$s" : "Vde. actualizou %1$s",
    "%2$s has revised %1$s to the revision of %3$s" : "%2$s revisou %1$s para a revisión de %3$s",
    "You reverted %1$s back to the revision of %3$s" : "Vde. reverteu %1$s cara a unha revisión anterior de %3$s",
    "%3$s has renamed %1$s to %2$s" : "%3$s renomeou %1$s a %2$s",
    "You renamed %1$s to %2$s" : "Vde. renomeou %1$s a %2$s",
    "%1$s has been deleted by %2$s" : "%1$s foi eliminado por %2$s",
    "You deleted %1$s" : "Vde. eliminou %1$s",
    "%1$s has been recovered by %2$s" : "%1$s foi recuperado por %2$s",
    "You recovered %1$s" : "Vde. recuperou %1$s",
    "%1$s has been permanently deleted by %2$s" : "%1$s foi eliminado definitivamente por %2$s",
    "You permanently deleted %1$s" : "Vde. eliminou %1$s definitivamente",
    ...
    "Credential deleted" : "Eliminouse a credencial",
    "Credential updated" : "Actualizouse a credencial",
    "Credential recovered" : "Recuperouse a credencial",
    "Credential destroyed" : "Destruíuse a credencial",
    ...
    "Failed to decrypt {{credential}}" : "Produciuse un fallo ao descifrar {{credential}}",
    "Done" : "Feito",
    ...
    "Missing an importer? Click here to try it with the generic CSV importer." : "Falta un importador? Prema aquí para probar co importador CSV xenérico.",
    ...
    "Generate password on creation" : "Xerar contrasinal na creación",
    ...
    "Rename vault" : "Cambiar o nome da bóveda",
    ...
    "Version" : "Versión",
    "Donate to support development" : "Doar para apoiar o desenvolvemento",
    ...
    "Generate sharing keys" : "Xerar claves para compartir",
    "Generating sharing keys" : "Xerando claves para compartir",
    ...
    "Uploading" : "Enviando",
    "User" : "Usuario",
    "Crypto time" : "Tempo de cifraxe",
    "Total time spent encrypting" : "Tempo total usado na cifraxe",
    "Read" : "Ler",
    "Write" : "Escribir",
    "Files" : "Ficheiros",
    "Revisions" : "Revisións",
    ...
    "by" : "por",
    "No revisions found." : "Non se atopou ningunha revisión.",
    "Label" : "Etiqueta",
    ...
    "You have incoming share requests." : "Vde. recibiu solicitudes para compartir. ",
    "If you want to put the credential in another vault," : "Se Vde. quere poñer as credenciais noutra bóveda,",
    ...
    "You don't have good credentials" : "Vde. non ten credenciais boas",
    "You don't have medium credentials" : "Vde. non ten credenciais medianas",
    "You don't have bad credentials" : "Vde. non ten credenciais malas",
    "You don't have expired credentials" : "Vde. non ten credenciais caducadas",
    "You don't have deleted credentials" : "Vde. non ten credenciais eliminadas",
    ...
    "Never" : "Nunca",
    "No vaults found, why not create one?" : "Non se atopou ningunha bóveda. Por que non crear unha?",
    ...
    "Your sharing keys will have a strength of 1024 bit, which you can change in \"Settings\" later." : "A súa chave para compartir terá unha forza de 1024 bits, que pode cambiar máis adiante en «Axustes».",
    ...
    "Set this vault as the default." : "Definir esta bóveda como predeterminada",
    ...
    "Loading …" : "Cargando…",
    "Oops! Credential not found. Maybe it expired." : "Vaites! Non se atopou a credencial, seica caducou.",
    "Mark as Compromised" : "Marcar como comprometido",
    "Compromised!" : "Comprometido!",
    "This password is compromised. You can only remove this warning by changing the password." : "Este contrasinal está comprometido. Só pode retirar esa advertencia cambiando o contrasinal.",
    "email" : "correo",
    "Description" : "Descrición",
    "Custom Search:" : "Busca personalizada:",
    "Revert to defaults" : "Reverter a valores predeterminados",
    "Your credential \"%s\" expired, click here to update the credential." : "A súa credencial «%s» caducou, prema aquí para actualizar a credencial.",
    "Remind me later" : "Lembrarmo más adiante",
    "Ignore" : "Ignorar",
    "%s shared \"%s\" with you. Click here to accept" : "%s compartiu «%s» con Vde. Prema aquí para aceptar",
