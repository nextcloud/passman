OC.L10N.register(
    ...
    "Since all data has to be downloaded, re-encrypted and uploaded again when changing the password, this process is error-prone. It is strongly recommended to have an updated backup of your vault before changing the password." : "Budući da se prilikom promjene lozinke svi podaci moraju preuzeti, ponovno šifrirati i ponovno prenijeti, ovaj je postupak sklon pogreškama. Snažno se preporučuje imati ažuriranu sigurnosnu kopiju vašeg sefa prije promjene lozinke.",
    ...
    "Generate password on creation" : "Generiraj lozinku pri stvaranju",
