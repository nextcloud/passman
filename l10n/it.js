OC.L10N.register(
    ...
    "Failed to decrypt {{credential}}" : "Impossibile decifrare {{credential}}",
    "Done" : "Fine",
    ...
    "Missing an importer? Click here to try it with the generic CSV importer." : "Manca un importatore? Fai clic qui per provare con l'importatore CSV generico.",
    ...
    "Loading …" : "Caricamento…",
    "Oops! Credential not found. Maybe it expired." : "Ops! Credenziali non trovate. Potrebbero essere scadute",
    ...
    "Enable global search" : "Attiva la ricerca globale",
