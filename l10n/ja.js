OC.L10N.register(
    ...
    "Failed to decrypt {{credential}}" : "複合に失敗 {{credential}}",
    "Done" : "完了",
    ...
    "Missing an importer? Click here to try it with the generic CSV importer." : "インポーターが見つかりませんか？一般的なCSVインポーターをお試しください。",
    ...
    "Your sharing keys will have a strength of 1024 bit, which you can change in \"Settings\" later." : "共有キーの強度は1024bitです。これは後で\"設定\"から変更できます。",
    ...
    "Log out of this vault automatically after:" : "この保管庫から次の期間後に自動的にログアウト:",
    ...
    "Loading …" : "読み込み中…",
    "Oops! Credential not found. Maybe it expired." : "証明書が見つかりません。もしかしたら期限切れかもしれません。",
    "Mark as Compromised" : "漏洩済みとしてマーク",
    ...
    "Enable global search" : "グローバル検索を有効",
