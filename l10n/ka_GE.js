OC.L10N.register(
    ...
    "The password tool will scan your password, calculate the average crack time and list those which are below the threshold" : "პაროლის ხელსაწყო დაასკანირებს თქვენს პაროლს, გამოთვილს გატეხვის საშუალო დროს და ჩამოწერს ზღვარს ქვემოთ მყოფებს",
    ...
    "log out of this vault and log in to the vault you want the shared credential in." : "გადით ამ სეიფიდან და შედით იმ სეიფში რომელშიც გსურთ მოთავსდეს გაზიარებული უფლებამოსილება.",
    ...
    "Your sharing key's will have a strength of 1024 bit, which you can change in Settings later ." : "თქვენს გაზიარების გასაღებს ექნება 1024 ბიტის სიძლიერე, რაც მოგვიანებით შეგიძლიათ შეცვალოთ პარამეტრებში.",
