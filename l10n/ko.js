OC.L10N.register(
    ...
    "Failed to decrypt {{credential}}" : "복호화 실패 ({credential})",
    "Done" : "완료",
    ...
    "Old password field incorrect!" : "이전 암호가 틀렸습니다",
    ...
    "Pick an icon" : "아이콘 선택",
    "Search icons" : "검색 아이콘",
    "Upload a custom icon:" : "사용자 지정 아이콘 업로드:",
    "Use this icon" : "이 아이콘 사용",
    "Delete current icon" : "현재 아이콘 삭제",
    "This may take a few seconds …" : "이 작업은 몇 초 정도 소요됩니다 ...",
    "There was an error fetching the icon!" : "아이콘을 불러오는 중 오류 발생",
    ...
    "Generate password on creation" : "생성 시 암호 생성",
    ...
    "Bookmarklet" : "북마크릿",
    "Save your passwords with one click." : "한 번의 클릭으로 암호를 저장하십시오.",
    ...
    "The password tool scans your password, calculates average cracking time, listing those below the threshold" : "암호 도구가 암호를 계산하고, 해킹에 소요되는 평균 시간을 계산하여, 지정한 시간보다 짧은 암호를 표시합니다",
    ...
    "User" : "사용자",
    "Crypto time" : "암호화 시간",
    "Total time spent encrypting" : "암호화 총 소요시간",
    "Read" : "읽기",
    "Write" : "쓰기",
    "Files" : "파일",
    "Revisions" : "리비전",
    ...
    "Click \"Share\" first" : "\"공유\"를 우선 클릭하십시오",
    "Show files" : "파일 보이기",
    "Details" : "자세한 정보",
    ...
    "log out of this vault and log into the vault you want the shared credential in." : "이 비밀 저장소에서 로그아웃한 다음, 공유할 인증 정보를 저장할 비밀 저장소에 로그인하십시오.",
    "Permissions" : "권한",
    ...
    "It does not seem that you have any passwords. Do you want to add one?" : "암호가 지정되지 않은 것 같습니다. 암호를 추가하시겠습니까?",
    "You don't have good credentials" : "강한 강도의 인증 정보가 없습니다",
    "You don't have medium credentials" : "보통 강도의 인증 정보가 없습니다",
    "You don't have bad credentials" : "약한 강도의 인증 정보가 없습니다",
    "You don't have expired credentials" : "만료된 인증 정보가 없습니다",
    "You don't have deleted credentials" : "삭제된 인증 정보가 없습니다",
    "There are no credentials with your selected tags" : "선택한 태그가 지정된 인증 정보가 없습니다",
    "There are no credentials matching" : "일치하는 인증 정보가 없습니다",
    ...
    "Your sharing keys will have a strength of 1024 bit, which you can change in \"Settings\" later." : "공유 키는 1024비트 크기로 생성되며 나중에 설정에서 변경할 수 있습니다.",
    ...
    "Logged into {{vault_name}}" : "{{vault_name}}에 로그인함",
    ...
    "Loading …" : "불러오는 중 ...",
    "Oops! Credential not found. Maybe it expired." : "인증 정보를 찾을 수 없습니다. 만료되었을 수 있습니다.",
    "Mark as Compromised" : "위태로운 강도로 표시",
    "Compromised!" : "강도가 위태롭습니다!",
    "This password is compromised. You can only remove this warning by changing the password." : "이 암호는 위태로운 강도입니다. 해당 암호를 변경해야 이 경고창이 사라집니다.",
    "email" : "이메일",
    "Description" : "설명",
    "Custom Search:" : "사용자 지정 검색:",
    "Revert to defaults" : "기본값으로 되돌리기",
    ...
    "Enable global search" : "전체 검색 활성화",
