OC.L10N.register(
    ...
    "Passwords" : "Passord",
    "Generating sharing keys (%s/2)" : "Genererer delingsnøkler (%s/2)",
    ...
    "An error occurred during decryption" : "En feil oppsto under dekryptering",
    ...
    "Error downloading file, you probably have insufficient permissions" : "Feil ved nedlasting av fil, du har sannsynligvis ikke tilstrekkelige tillatelser.",
    ...
    "Failed to decrypt {{credential}}" : "Dekryptering av {{credential}} feilet",
    "Done" : "Ferdig",
    "File read." : "Fil lest.",
    "Proceed with the following steps to import your file" : "Fortsett med følgende steg for å importere filen din",
    "Skipping unlabeled credential" : "Hopper over umerket legitimasjon",
    ...
    "Missing an importer? Click here to try it with the generic CSV importer." : "Mangler du importør? Klikk her for å prøve med den generiske CSV-importøren.",
    ...
    "Since all data has to be downloaded, re-encrypted and uploaded again when changing the password, this process is error-prone. It is strongly recommended to have an updated backup of your vault before changing the password." : "Siden alle data må lastes ned, krypteres på nytt og lastes opp igjen når du endrer passordet, er denne prosessen utsatt for feil. Det anbefales på det sterkeste å ha en oppdatert sikkerhetskopi av hvelvet ditt før du endrer passordet.",
    ...
    "Old password field incorrect!" : "Gammelt passordfelt er feil!",
    ...
    "Credential unshared" : "Deling av påloggingsdetalj trukket tilbake",
    ...
    "Upload a custom icon:" : "Last opp et tilpasset ikon:",
    "Use this icon" : "Bruk dette ikonet",
    "Delete current icon" : "Slett gjeldende ikon",
    "Get icon from page" : "Få ikon fra siden",
    "This may take a few seconds …" : "Dette kan ta noen sekunder...",
    "There was an error fetching the icon!" : "Det oppstod en feil under henting av ikonet!",
    ...
    "Generate password on creation" : "Generer passord ved opprettelse",
    ...
    "Save your passwords with one click." : "Lagre passordene dine med ett klikk.",
    ...
    "The password tool scans your password, calculates average cracking time, listing those below the threshold" : "Passordverktøyet vil skanne passordet ditt, kalkulere gjennomsnittlig tid for knekking og liste dem som er under terskelen",
    ...
    "Total time spent encrypting" : "Total tid brukt på kryptering",
    "Read" : "Les",
    "Write" : "Skriv",
    "Files" : "Filer",
    ...
    "Share credential {{credential}}" : "Del påloggingsdetalj {{credential}}",
    ...
    "log out of this vault and log into the vault you want the shared credential in." : "logg ut av dette hvelvet og logg inn i hvelvet du vil ha den delte legitimasjonen i.",
    ...
    "Hello there!" : "Hei der!",
    "It does not seem that you have any passwords. Do you want to add one?" : "Det ser ikke ut til at du har noen passord. Vil du legge til et?",
    "You don't have good credentials" : "Du har ikke god legitimasjon",
    "You don't have medium credentials" : "Du har ikke middels legitimasjon",
    "You don't have bad credentials" : "Du har ikke dårlig legitimasjon",
    "You don't have expired credentials" : "Du har ikke utløpt legitimasjon",
    "You don't have deleted credentials" : "Du har ikke slettet legitimasjon",
    "There are no credentials with your selected tags" : "Det er ingen legitimasjon med de valgte merkelappene",
    "There are no credentials matching" : "Det er ingen legitimasjon som samsvarer med",
    ...
    "Your sharing keys will have a strength of 1024 bit, which you can change in \"Settings\" later." : "Delingsnøklene dine vil ha en styrke på 1024 bit, som du kan endre i \"Innstillinger\" senere.",
    ...
    "Logged into {{vault_name}}" : "Logget inn på {{vault_name}}",
    ...
    "Medium Strength" : "Middels styrke",
    "Bad Strength" : "Dårlig styrke",
    "Expired" : "Utløpt",
    "Compromised" : "Kompromittert",
    "Filter Tags" : "Filtrer merkelapper",
    "Simple Navigation" : "Enkel navigasjon",
    ...
    "Loading …" : "Laster ...",
    "Oops! Credential not found. Maybe it expired." : "Ops! Legitimasjon ikke funnet. Kanskje den er utløpt.",
    "Mark as Compromised" : "Merk som kompromittert",
    "Compromised!" : "Kompromittert!",
    "This password is compromised. You can only remove this warning by changing the password." : "Passordet er kompromittert. Du kan kun fjerne advarselen ved å endre passordet.",
    "email" : "e-post",
    "Description" : "Beskrivelse",
    "Custom Search:" : "Tilpasset søk:",
    "Revert to defaults" : "Tilbakestill til standard",
    ...
    "Enable global search" : "Aktiver globalt søk",
