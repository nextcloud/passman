OC.L10N.register(
    ...
    "Since all data has to be downloaded, re-encrypted and uploaded again when changing the password, this process is error-prone. It is strongly recommended to have an updated backup of your vault before changing the password." : "Omdat alle gegevens moeten worden gedownload, opnieuw gecodeerd en opnieuw geüpload bij het wijzigen van het wachtwoord, is dit proces foutgevoelig. Het wordt sterk aanbevolen om een actuele back-up van je kluis te hebben voordat je het wachtwoord wijzigt.",
    ...
    "Search icons" : "Zoeken in pictogrammen",
    "Upload a custom icon:" : "Upload een aangepast pictogram:",
    "Use this icon" : "Dit pictogram gebruiken",
    "Delete current icon" : "Huidige pictogram verwijderen",
    "Get icon from page" : "Pictogram van pagina verkrijgen",
    ...
    "Generate password on creation" : "Wachtwoord genereren bij aanmaken",
    ...
    "Disable JavaScript debugger" : "JavaScript-debugger uitschakelen",
