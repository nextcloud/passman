OC.L10N.register(
    ...
    "Error loading file" : "Błąd wczytywania pliku",
    ...
    "Failed to decrypt {{credential}}" : "Nie udało się odszyfrować {{credential}}",
    "Done" : "Zrobione",
    ...
    "Missing an importer? Click here to try it with the generic CSV importer." : "Brakuje importera? Kliknij tutaj, aby wypróbować go z ogólnym importerem CSV.",
    "Go back to importers." : "Powrót do mechanizmów importujących.",
    ...
    "Size" : "Rozmiar",
    "Upload or enter your OTP secret" : "Wyślij plik lub wprowadź swój tajny klucz OTP",
    ...
    "Go back to vaults" : "Powrót do sejfów",
    ...
    "Loading" : "Wczytywanie",
    "Oops! Credential not found. Maybe it expired." : "Ups… Nie znaleziono poświadczenia. Może wygasło.",
    ...
    "Search for a user" : "Szukaj użytkownika",
