OC.L10N.register(
    ...
    "Showing revisions of \"{{label}}\"" : "Exibindo revisões de \"{{label}}\"",
    ...
    "There are no credentials with your selected tags" : "Não há credenciais com as etiquetas selecionadas",
    ...
    "Passman" : "Passman",
    "Passwords" : "Senhas",
    "Passman is a full-featured password manager." : "O Passman é um gerenciador de senhas com todos os recursos.",
    "**Passman** is a full-featured, open source password manager for Nextcloud.\n\n## Features:\n- Vaults\n- Vault key is never sent to the server\n- Browser extension for easy access to passwords\n- Android app for on the road access\n- Credentials are client side encrypted with 256bit AES\n- Credentials are server side encrypted with 256bit AES\n- Ability to add custom fields to credentials\n- Built-in OTP (One Time Password) generator\n- Password analyzer\n- Share passwords internally and via link in a secure manner.\n- Import from various password managers (KeePass, LastPass, DashLane, ZOHO, Clipperz.is)\n\n## Demo\nFor a demo of this app visit [https://demo.passman.cc](https://demo.passman.cc)" : "O **Passman** é um gerenciador de senhas de código aberto e com recursos completos para o Nextcloud.\n\n## Recursos:\n- Cofres\n- A chave do cofre nunca é enviada ao servidor\n- Extensão para navegador para fácil acesso às senhas\n- Aplicativo para Android para acesso em qualquer lugar\n- As credenciais são criptografadas no lado do cliente com AES de 256 bits\n- As credenciais são criptografadas no lado do servidor com AES de 256 bits\n- Possibilidade de adicionar campos personalizados às credenciais\n- Gerador de OTP (senha de uso único) integrado\n- Analisador de senhas\n- Compartilhe senhas internamente e por meio de link de maneira segura.\n- Importação de vários gerenciadores de senhas (KeePass, LastPass, DashLane, ZOHO, Clipperz.is)\n\n## Demonstração\nPara uma demonstração deste aplicativo, acesse [https://demo.passman.cc](https://demo.passman.cc)",
    ...
    "Minimum vault key strength" : "Força mínima da chave do cofre",
