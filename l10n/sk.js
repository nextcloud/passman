OC.L10N.register(
    ...
    "Showing revisions of \"{{label}}\"" : "Zobrazujú sa revízie „{{label}}“",
    "Revision of" : "Revízia",
    "by" : "od",
    ...
    "Passman" : "Passman",
    "Passwords" : "Heslá",
    "Passman is a full-featured password manager." : "Passman je plnohodnotný správca hesiel.",
    "**Passman** is a full-featured, open source password manager for Nextcloud.\n\n## Features:\n- Vaults\n- Vault key is never sent to the server\n- Browser extension for easy access to passwords\n- Android app for on the road access\n- Credentials are client side encrypted with 256bit AES\n- Credentials are server side encrypted with 256bit AES\n- Ability to add custom fields to credentials\n- Built-in OTP (One Time Password) generator\n- Password analyzer\n- Share passwords internally and via link in a secure manner.\n- Import from various password managers (KeePass, LastPass, DashLane, ZOHO, Clipperz.is)\n\n## Demo\nFor a demo of this app visit [https://demo.passman.cc](https://demo.passman.cc)" : "**Passman** je plnohodnotný správca hesiel s otvoreným zdrojovým kódom pre Nextcloud.\n\n## Funkcie:\n- Trezory\n- Kľúč trezoru sa nikdy neodosiela na server\n- Rozšírenie prehliadača na jednoduchý prístup k heslám\n- Aplikácia pre Android na prístup k heslám na cestách\n- Prihlasovacie údaje sa na strane klienta šifrujú pomocou 256bit AES\n- Prihlasovacie údaje sa na strane servera šifrujú pomocou 256bit AES\n- Možnosť pridávať k prihlasovacím údajom vlastné polia\n- Zabudovaný generátor OTP (jednorazového hesla)\n- Analyzátor hesiel\n- Bezpečné zdieľanie hesiel interne aj prostredníctvom odkazu.\n- Import z rôznych správcov hesiel (KeePass, LastPass, DashLane, ZOHO, Clipperz.is)\n\n## Ukážka\nUkážku tejto aplikácie nájdete na [https://demo.passman.cc](https://demo.passman.cc)",
    ...
    "Minimum vault key strength" : "Minimálna sila kľúča trezoru",
