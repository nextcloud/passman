OC.L10N.register(
    ...
    "Since all data has to be downloaded, re-encrypted and uploaded again when changing the password, this process is error-prone. It is strongly recommended to have an updated backup of your vault before changing the password." : "Пошто је, када се мења лозинка, потребно да се сви подаци преузму, поново шифрују, па отпреме, овај процес је подложан грешкама. Снажно се препоручује да имате свежу резервну копију свог сефа пре него што промените лозинку.",
    "I understand the risks" : "Разумем ризике",
    "Sharing" : "Дељење",
