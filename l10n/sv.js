OC.L10N.register(
    ...
    "Please wait your vault is being updated, do not leave this page." : "Vänta, ditt valv håller på att uppdateras. Lämna inte denna sida!",
    ...
    "The password tool scans your password, calculates average cracking time, listing those below the threshold" : "Lösenordsverktyget skannar ditt lösenord, beräknar den genomsnittliga tiden för att knäcka och visar resultatet nedan",
    "Minimum password stength" : "Minsta lösenordsstyrka",
    "Start scan" : "Påbörja skanning",
    "Result" : "Resultat",
    "A total of {{scan_result}} weak credentials were found." : "Totalt {{scan_result}} svagt/svaga lösenord hittades.",
    "Score" : "Poäng",
    "Action" : "Ågärd",
    ...
    "Loading …" : "Läser in …",
    "Oops! Credential not found. Maybe it expired." : "Det gick inte att hitta inloggningsuppgifterna. Kanske har de gått ut.",
