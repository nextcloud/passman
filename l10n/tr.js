OC.L10N.register(
    ...
    "A Passman item has been created, modified or deleted" : "Bir Passman ögesi oluşturuldu, değiştirildi ya da silindi",
    ...
    "%1$s has been created by %2$s" : "%2$s %1$s ögesini oluşturdu",
    "You created %1$s" : "%1$s ögesini oluşturdunuz",
    ...
    "%1$s has been recovered by %2$s" : "%2$s, %1$s ögesini kurtardı",
    ...
    "Missing an importer? Click here to try it with the generic CSV importer." : "Eksik bir içe aktarma uygulaması mı var? Genel CSV içe aktarma uygulamasını denemek için buraya tıklayın.",
    ...
    "Month(s)" : "Ay",
    "Year(s)" : "Yıl",
    "Password generation settings" : "Parola oluşturma ayarları",
    ...
    "Repeat new vault password" : "Yeni kasa parolası onayı",
    ...
    "Generate sharing keys" : "Paylaşım anahtarlarını oluştur",
    "Generating sharing keys" : "Paylaşım anahtarları oluşturuluyor",
    ...
    "Missing users? Only users that have vaults are shown." : "Kullanıcılar eksik mi? Yalnızca kasası olan kullanıcılar görüntüleniyor.",
    "Cyphering" : "Şifreleme",
    ...
    "100/hour" : "100/saat",
    "Throttled online attack" : "Kısıtlanmış çevrim içi saldırı",
    "10/second" : "10/saniye",
    "Unthrottled online attack" : "Kısıtlanmamış çevrim içi saldırı",
    "10k/second" : "10k/saniye",
    "Offline attack, slow hash, many cores" : "Çevrim dışı saldırı, yavaş karma, çok çekirdek",
    "10B/second" : "10B/saniye",
    "Offline attack, fast hash, many cores" : "Çevrim dışı saldırı, hızlı karma, çok çekirdek",
    ...
    "Showing revisions of \"{{label}}\"" : "\"{{label}}\" sürümleri görüntüleniyor",
    ...
    "Create new credential" : "Yeni kimlik doğrulama bilgisi oluştur",
    "Save" : "Kaydet",
    "Cancel" : "İptal",
    "Settings" : "Ayarlar",
    ...
    "URL" : "Adres",
    "Notes" : "Notlar",
    "Expiry time" : "Geçerlilik sonu zamanı",
    ...
    "Disable context menu" : "Sağ tık menüsü kapatılsın",
    "Disable JavaScript debugger" : "JavaScript hata ayıklaması kapatılsın",
    "Enable global search" : "Genel arama açılsın",
    "Minimum vault key strength" : "En kısa kasa anahtarı karmaşıklığı",
