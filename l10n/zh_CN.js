OC.L10N.register(
    ...
    "Passwords" : "密码",
    "Generating sharing keys (%s/2)" : "生成共享密钥中 (%s/2)",
    ...
    "Failed to decrypt {{credential}}" : "解密{{credential}}失败",
    "Done" : "完成",
    "File read." : "文件读取。",
    ...
    "Missing an importer? Click here to try it with the generic CSV importer." : "缺少导入器？点击此处尝试通用 CSV 导入器",
    ...
    "Deleting {{password}} …" : "正删除 {{password}} …",
    ...
    "Log out of this vault automatically after:" : "多少时间后自动退出登录此密码库：",
    "Decrypt vault" : "加密保险箱",
    ...
    "Loading …" : "加载中 ...",
    "Oops! Credential not found. Maybe it expired." : "哦! 没找到凭据。也许它过期了。",
