OC.L10N.register(
    ...
    "Share link" : "分享連結",
    "Are you sure you want to leave? This will corrupt this credential" : "您確認要離開嗎？這將銷毀此憑證",
    "Credential unshared" : "取消了憑證分享",
    "Credential shared" : "憑證已分享",
    "Saved!" : "保存了！",
    "Poor" : "差 ",
    "Weak" : "弱",
    "Good" : "好 ",
    ...
    "If you want to put the credential in another vault," : "如果您想將證書放在另一個保險庫中，",
    "log out of this vault and log into the vault you want the shared credential in." : "登出此保險庫並登錄到您要共享證書的保險庫。",
    "Permissions" : "權限",
    "Received from" : "接受自",
    "Date" : "日期",
    "Accept" : "接受",
    ...
    "Your vault has been locked for {{time}} because of {{tries}} failed attempts!" : "由於{{試圖}}嘗試已失敗，您的保險庫已鎖定{{time}}",
    "Hello there!" : "嘿，您好！",
    ...
    "Last accessed" : "上次訪問",
    "Never" : "從不",
    "No vaults found, why not create one?" : "沒有找到保險庫，為什麼不創建一個？",
    "Password strength must be at least: {{strength}}" : "密碼強度必須至少為{{strength}}",
    "Please give your new vault a name." : "請給您的新保險庫一個名字。",
    ...
    "Set this vault as the default." : "將此保險庫設置為默認值。",
    "Log into this vault automatically." : "自動登入保險庫",
    "Log out of this vault automatically after: " : "在以下情況下自動登出此保險庫：",
    "Decrypt vault" : "加密保險庫",
    "Seems you lost the vault password and you're unable to log in." : "似乎丟失了保險庫密碼，您無法登錄。",
    "If you want this vault to be removed you can request that here." : "如果您想刪除這個保險庫，您可以在這裡請求。",
    "An admin then accepts or declines the request" : "然後，管理員接受或拒絕該請求",
    "After an admin destroys this vault, all credentials in it will be lost" : "管理員銷毀此保險庫後，其中的所有憑據將丟失",
