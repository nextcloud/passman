OC.L10N.register(
    ...
    "Credential created!" : "創建憑證",
    "Credential deleted" : "憑據已刪除",
    "Credential updated" : "憑證更新",
    "Credential recovered" : "憑證回收",
    "Credential destroyed" : "憑證銷毀",
    "Error downloading file, you probably have insufficient permissions" : "下載文件時發生錯誤，您可能沒有足夠的權限",
    "Invalid QR code" : "無效的 QR 代碼",
    "Starting export" : "正在開始導出",
    "Decrypting credentials" : "憑證解密",
    "Done" : "完成",
    "File read." : "文件已被讀取。",
    "Proceed with the following steps to import your file" : "按以下步驟處理以導入您的文件",
    "Skipping unlabeled credential" : "跳過無標籤的憑據",
    "Adding {{credential}}" : "添加 {{credential}}",
    "Added {{credential}}" : "已添加 {{credential}}",
    "Skipping credential, missing label on line {{line}}" : "跳過憑證，缺少標籤{{line}}",
    "Parsed {{num}} credentials, starting to import" : "解析 {{num}} 個憑據，開始導入",
    "Importing" : "正在導入",
    "Start import" : "開始導入",
    "Select CSV file" : "選擇 CSV 文件",
    "Parsed {{rows}} lines from CSV file" : "從 CSV 文件解析了 {{rows}} 行",
    "Skip first row" : "跳轉到第一行",
    "You need to assign the label field before you can start the import." : "開始導入之前需要先關聯標籤字段。",
    "The first 5 lines of the CSV are shown." : "顯示 CSV 的前 5 行。",
    "Assign the proper fields to each column." : "為每一列關聯恰當的字段。",
    "Example of imported credential" : "導入的憑證示例",
    ...
    "Import credentials" : "導入憑據",
    "Export credentials" : "導出憑據",
    "Sharing" : "正在共享",
    ...
    "%s has been shared with a link" : "%s 已被共享通過鏈接",
    "Passwords" : "密碼",
    ...
    "Allow users on this server to share passwords with a link" : "允許此服務器上的用戶通過鏈接共享密碼 ",
