OC.L10N.register(
    ...
    "Failed to decrypt {{credential}}" : "無法解密 {{credential}}",
    "Done" : "完成",
    "File read." : "檔案已被讀取。",
    ...
    "Missing an importer? Click here to try it with the generic CSV importer." : "沒有導入器？單擊此處嘗試使用通用 CSV 導入器。",
    ...
    "Pick an icon" : "選擇一個圖標",
    "Search icons" : "搜索圖標",
    "Upload a custom icon:" : "上傳自訂圖標：",
    "Use this icon" : "使用此圖標",
    "Delete current icon" : "刪除目前圖標",
    ...
    "Current OTP settings" : "目前的 OTP 設置 ",
    "Issuer" : "發行者",
    "Secret" : "密鑰",
    "Digits" : "數字",
    "Period" : "時段",
    ...
    "Export type" : "匯出類型",
    "Export" : "匯出",
    "Enter vault password to confirm export." : "輸入保險庫密碼以確認匯出。",
    "Rename vault" : "重命名保險庫",
    ...
    "Showing revisions of \"{{label}}\"" : "正在顯示「{{label}}」的修訂版本",
    "Revision of" : "修訂",
    "by" : "由",
    ...
    "Request vault destruction" : "要求銷毀保險庫",
    "Yes, request an admin to destroy this vault" : "是的，要求管理員銷毀此保險庫",
    "Cancel destruction request" : "取消銷毀要求",
    "Vault destruction requested" : "已要求銷毀保險庫",
    "Request removed" : "請求已移除",
    "Destruction request pending" : "銷毀要求待處理",
    ...
    "**Passman** is a full-featured, open source password manager for Nextcloud.\n\n## Features:\n- Vaults\n- Vault key is never sent to the server\n- Browser extension for easy access to passwords\n- Android app for on the road access\n- Credentials are client side encrypted with 256bit AES\n- Credentials are server side encrypted with 256bit AES\n- Ability to add custom fields to credentials\n- Built-in OTP (One Time Password) generator\n- Password analyzer\n- Share passwords internally and via link in a secure manner.\n- Import from various password managers (KeePass, LastPass, DashLane, ZOHO, Clipperz.is)\n\n## Demo\nFor a demo of this app visit [https://demo.passman.cc](https://demo.passman.cc)" : "**Passman** 是一款功能完善的 Nextcloud 開源密碼管理器。\n\n## 功能特色：\n- 保險庫（Vault）\n- 保險庫金鑰絕不會傳送至伺服器\n- 提供瀏覽器擴充功能，方便存取密碼\n- 提供 Android 應用程式，方便外出時使用\n- 憑證資料於用戶端以 256 位元 AES 加密\n- 憑證資料於伺服器端以 256 位元 AES 加密\n- 可為憑證新增自訂欄位\n- 內建 OTP（一次性密碼）產生器\n- 密碼分析工具\n- 可安全地於內部或透過連結分享密碼\n- 支援從多種密碼管理器匯入資料（KeePass、LastPass、DashLane、ZOHO、Clipperz.is）\n## 示範\n如欲體驗此應用程式，請前往 [https://demo.passman.cc](https://demo.passman.cc)",
    ...
    "Enable global search" : "啟用全域搜尋",
    "Minimum vault key strength" : "最短保險庫密鑰長度",
